...
export function Nav() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 h-16 flex items-center justify-between gap-4 text-xs">
          <Link
            href="#home"
            className="flex items-center gap-3 text-matrix glow-matrix hover:text-matrix-soft transition-colors shrink-0"
            data-cursor="hover"
          >
            ...
            <span className="text-ink-dim/50 hidden xl:inline">
              :~/portfolio.sys
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              data-cursor="hover"
              className="group inline-flex items-center gap-2 px-3 py-1.5 border border-matrix/50 text-matrix hover:bg-matrix/10 hover:border-matrix hover:shadow-[0_0_18px_rgba(0,255,65,0.35)] transition-all whitespace-nowrap"
            >
